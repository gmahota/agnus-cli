...
async function makeTaskCommand() {
  ...
  //   const finalizeTaskController = new FinalizeTaskController();
  //   const tagTaskController = new TagTaskController();
  //   const showNextTasksController = new ShowNextTasksController();

  taskCommand
    .description(
      "Can be used in conjunction with another command to create new tasks\n and to remove, update or list existing tasks.",
      {
  ...
  taskCommand
    ...
    .addOption(
      new Option(
        "-p, --priority <value>",
        "Set a task's priority to low, normal or high."
      )
  ...
  //     .description(
  //       "Updates a task's status to done by providing the corresponding id.",
  //       {
  ...
  taskCommand
    ...
    .description(
      "Updates a task's tag by providing the corresponding id and a tag title.",
      {
  ...
  taskCommand
    ...
    .description(
      "Removes a task's tag property by providing the corresponding id.",
      {
  ...
  taskCommand
    ...
    .description(
      "Lists all tasks. Optionally only show tasks with the given status by using the -s option. (alias: --show)."
    )
    .addOption(
      new Option(
        "-s, --show <status>",
        "Only show tasks whose status is pending or done."
  ...
  taskCommand
    ...
    .description(
      "Lists the next pending tasks. Only shows the oldest task of each priority."
    )
    .action(async () => {
